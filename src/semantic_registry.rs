...
mod tests {
    ...
    fn production_registry_is_complete_and_numeric_lookups_are_checked() {
        ...
        assert_eq!(
            signature_from_numeric(41).map(|descriptor| descriptor.primitive_name),
            Ok("tan")
        );
        assert_eq!(
            implementation_from_numeric(41).map(|descriptor| descriptor.kernel),
        ...
        assert_eq!(
            signature_from_numeric(43).map(|descriptor| descriptor.primitive_name),
            Ok("ceil")
        );
        assert_eq!(
            implementation_from_numeric(43).map(|descriptor| descriptor.kernel),
